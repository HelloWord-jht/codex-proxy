export const translations = {
  en: {
    ...
    apiCallRecords: "API Call Records",
    ...
    callStatus: "Status",
    modelInfo: "Model",
    interfaceNameOrUrl: "Interface / URL",
    callTime: "Started At",
    callFinishedTime: "Finished At",
    durationMs: "Duration",
    ...
    noApiCallRecords: "No API call records yet",
  ...
  zh: {
    ...
    failedCalls: "失败次数",
    totalTokenConsumption: "Token 总消耗",
    callStatus: "状态",
    interfaceNameOrUrl: "接口 / URL",
    callTime: "调用时间",
    callFinishedTime: "结束时间",
    durationMs: "耗时",
