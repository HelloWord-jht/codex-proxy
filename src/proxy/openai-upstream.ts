...
export class OpenAIUpstream implements UpstreamAdapter {
  ...
  getRequestLogInfo(_req: CodexResponsesRequest): ApiCallRequestInfo {
    return {
      interfaceIdentifier: `${this.tag}.chat.completions`,
      interfaceName: `${this.tag} /chat/completions`,
      interfaceUrl: `${this.baseUrl}/chat/completions`,
    };
  }
